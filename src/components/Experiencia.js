export default function Experiencia() {
    return (
      <section id="experiencia" className="transition-all duration-300 ease-in-out bg-white/10 backdrop-blur-sm rounded-lg p-6 shadow-lg border border-white/10">
        <h2 className="text-3xl tracking-wide leading-relaxed font-semibold text-[#2095ff] mb-4">Experiencia Profesional</h2>
  
        {/* EXPERIENCIA EN EL SECTOR */}
        <div className="mb-6">
          <h3 className="text-2xl tracking-wide leading-relaxed font-semibold text-[#99cfff] mb-2">Experiencia en el sector</h3>
          <div className="mb-4 tracking-wide leading-relaxed text-lg text-white">
            ...
            <ul className="list-disc tracking-wide leading-relaxed list-inside text-lg text-white">
        ...
        <div>
          <h3 className="text-2xl tracking-wide leading-relaxed font-semibold text-[#99cfff] mb-2">Otras experiencias profesionales</h3>
          
          <div className="mb-4 tracking-wide leading-relaxed text-white text-lg">
