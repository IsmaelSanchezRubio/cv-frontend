export default function Habilidades() {
    return (
      <section id="habilidades" className="transition-all duration-300 ease-in-out bg-white/10 backdrop-blur-sm rounded-lg p-6 shadow-lg border border-white/10">
        <h2 className="text-2xl font-semibold text-[#2095ff] mb-4">Habilidades</h2>
  
        {/* Habilidades técnicas */}
        <div className="mb-6">
          <h3 className="text-xl font-semibold text-[#99cfff] mb-2">Técnicas</h3>
        ...
        <div>
          <h3 className="text-xl font-semibold text-[#99cfff] mb-2">Teletrabajo y colaboración remota</h3>
          <ul className="list-disc list-inside text-sm text-white space-y-1">
